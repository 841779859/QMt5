...
import com.example.asus.qmt5.Personalcenter.activity.basic.ActivityStack;
...
public class KevinApplication extends Application {
    ...
    public void onCreate() {
        ...
        httpConfig.addCommonField("version_code", "" + data.getVersionCode(getApplicationContext()));
