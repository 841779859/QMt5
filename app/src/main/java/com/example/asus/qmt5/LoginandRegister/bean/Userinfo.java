...
public class Userinfo {
   ...
   public Userinfo(String phonenumber,  String username, String IDcardnum,String IDpic, String realname, String birthday, String sex, String email, int permission){
       super();
       this.phonenumber=phonenumber;
