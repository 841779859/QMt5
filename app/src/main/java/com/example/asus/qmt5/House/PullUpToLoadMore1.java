 ...
 */
public class PullUpToLoadMore1 extends ViewGroup {
    public static String TAG = PullUpToLoadMore1.class.getName();

    MyScrollView1 topScrollView, bottomScrollView;
    ...
    public PullUpToLoadMore1(Context context) {
        super(context);
        init();
    }

    public PullUpToLoadMore1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PullUpToLoadMore1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                topScrollView = (MyScrollView1) getChildAt(0);
                bottomScrollView = (MyScrollView1) getChildAt(1);
                topScrollView.setScrollListener(new MyScrollView1.ScrollListener() {
                    @Override
                ...
                bottomScrollView.setScrollListener(new MyScrollView1.ScrollListener() {
                    @Override
                    public void onScrollToBottom() {
