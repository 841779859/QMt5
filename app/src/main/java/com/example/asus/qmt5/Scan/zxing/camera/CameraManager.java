...
package com.example.asus.qmt5.Scan.zxing.camera;
...
import com.example.asus.qmt5.Scan.zxing.decode.PlanarYUVLuminanceSource;
 ...
 */
/*
*   在CameraManager类中，提供了手机摄像头初始化的接口、摄像头预览回调、自动对焦
* 回调等接口。摄像头的配置信息则由CameraConfigurationManager类提供。另外还提供了
* 一个获取从摄像头显示的图像界面中获取扫描框内获取PlanarYUVLuminanceSource类型的
* 图像数据的方法buildLuminanceSource()方法
* */
public final class CameraManager {
	...
	public void openDriver(SurfaceHolder holder) throws IOException {
		if (camera == null) {
			...
			camera.setPreviewDisplay(holder);//得到camera的数据
	 ...
	 */
	public Rect getFramingRect() {//扫描框修改
	...
	public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
														 /**获取扫描框在摄像头预览界面中的位置*/int width, int height) {
