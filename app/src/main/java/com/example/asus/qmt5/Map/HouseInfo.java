...
public class HouseInfo {
    ...
    public HouseInfo(String house_introduce, String house_addr,
                     String house_price) {
        super();
    ...
    public HouseInfo(String house_name ,String house_introduce,String house_addr,String house_price){
        super();
        this.house_name=house_name;
        this.house_introduce=house_introduce;//锟斤拷值锟斤拷锟斤拷house_introduce锟斤拷锟斤拷
        this.house_addr=house_addr;
        this.house_price=house_price;
    }
    ...
    public HouseInfo( String house_ID,String house_name,String house_addr,String house_position,
                      String house_price, String house_state,String house_introduce,String house_img )
    //,String house_img, String house_img2, String house_img3,String house_img4)
    {
        super();
